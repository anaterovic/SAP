...
```
cd existing_repo
git remote add origin https://gitlab.com/tinferkovic/macroeconomic-analysis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tinferkovic/macroeconomic-analysis/-/settings/integrations)
